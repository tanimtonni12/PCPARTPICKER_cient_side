...
const DeleteAllOrder = ({ deletingOrder, refetch, setDeletingOrder }) => {
    ...
    const handleDelete = () => {
        fetch(`https://morning-everglades-64553.herokuapp.com/order/${_id}`, {
            method: 'DELETE',
            headers: {
    ...
    return (
        <div>
            <input type="checkbox" id="all-order-delete-confirm-modal" class="modal-toggle" />
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <div class="modal-action">
                        ...
                        <label htmlFor="all-order-delete-confirm-modal" class="btn btn-xs">Cancel</label>
                    </div>
                </div>
            </div>
        </div >
